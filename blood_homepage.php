...
<!-- Header -->
  ...
  <div class="w3-col m4 w3-margin-left">
        <p class="w3-center "><img src="./Images/Logo.png" alt="Blood camps" style="width:100%"></p>
   </div>  
  ...
  <div class="w3-row-padding w3-grayscale">
    <div class="w3-col m4 w3-margin-bottom">
      <div class="w3-light-grey">
        <img src="./Images/city.jpg" alt="City" style="width:100%">
        <div class="w3-container">
          <h3>City</h3>
    ...
    <div class="w3-col m4 w3-margin-bottom">
      <div class="w3-light-grey">
        <img src="./Images/Plasma.jpg" alt="Blood camps" style="width:100%">
        <div class="w3-container">
          <h3>Blood camps</h3>
    ...
    <div class="w3-col m4 w3-margin-bottom">
      <div class="w3-light-grey">
        <img src="./Images/Hospital.jpg" alt="Hospitals" style="width:100%">
        <div class="w3-container">
          <h3>Hospitals</h3>
...
<div class="w3-light-grey w3-container w3-padding-32" style="margin-top:75px;padding-right:58px"><p class="w3-center"><a href="./who-can-get-my-blood/dist/"><b>Who can I donate my Blood too?</b></a></p></div>
